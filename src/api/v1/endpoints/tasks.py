...
from src.problems.crud.tasks import task_crud
...
async def get_tasks(
    ...
    return await task_crud.get_multi(session, filters=filters)
...
async def create_task(
    ...
    # )
    # return task_schema
    return await task_crud.create(session, task)
...
async def update_task(
    ...
    # return task_schema
    return await task_crud.update(session, task_id, task)
...
async def delete_task(
    ...
    return await task_crud.remove(session, task_id)
