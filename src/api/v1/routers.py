...
from src.api.v1.endpoints import main_page_router, department_router, user_router, survey_router
...
main_router.include_router(survey_router, prefix='/survey', tags=['Surveys'])
