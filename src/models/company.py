...
class Company(BaseTabitModel):
    ...
    id: Mapped[int_pk]
    name: Mapped[str] = mapped_column(String(Length.MAX_NAME_COMPANY), nullable=False)
...
class Department(BaseTabitModel):
    ...
    id: Mapped[int_pk]
    name: Mapped[str] = mapped_column(String(Length.MAX_NAME_DEPARTMENT), nullable=False)
