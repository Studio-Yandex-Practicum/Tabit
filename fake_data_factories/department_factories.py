...
from fake_data_factories.constants import DEFAULT_DEPARTMENT_NAMES, FAKER_DEPARTMENT_COUNT, Color
...
async def create_company_department(count=FAKER_DEPARTMENT_COUNT, **kwargs):
    ...
    cprint(f'Создано {count} департаментов компании c id: {kwargs["company_id"]}', Color.green)
