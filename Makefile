.PHONY: up down up-pgadmin down-pgadmin logs init-migrations apply-migrations reset-db init-db run clean-volumes fill-problems fill-message-feeds fill-tasks
