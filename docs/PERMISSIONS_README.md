...
| Эндпоинт                         | Метод  | TS | TA | CM | CU | Описание                       |
|----------------------------------|--------|----|----|----|----|--------------------------------|
| /                                | GET    | +  | +  | -  | -  | Получить общую информацию по   |
|                                  |        |    |    |    |    | по компаниям                   |
| /staff                           | GET    | +  | +  | -  | -  | Получить информацию по всем    |
|                                  |        |    |    |    |    | сотрудникам компаний           |
| /staff                           | POST   | +  | +  | -  | -  | Создать нового сотрудника      |
|                                  |        |    |    |    |    | компании                       |
| /staff/{user_id}                 | GET    | +  | +  | -  | -  | Получить информацию об         |
|                                  |        |    |    |    |    | администраторе                 |
| /staff/{user_id}                 | PUT    | +  | +  | -  | -  | Полностью изменить информацию  |
|                                  |        |    |    |    |    | об администраторе              |
| /staff/{user_id}                 | PATCH  | +  | +  | -  | -  | Частично изменить информацию   |
|                                  |        |    |    |    |    | об администраторе              |
| /staff/{user_id}                 | DELETE | +  | +  | -  | -  | Удалить информацию о           |
|                                  |        |    |    |    |    | администраторе                 |
| /staff/{user_id}/resetpassword   | POST   | +  | +  | -  | -  | Сброс пароля администратора    |
|                                  |        |    |    |    |    | администратора                 |
