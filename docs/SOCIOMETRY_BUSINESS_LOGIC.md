...
Данный документ описывает бизнес-логику для реализации модуля социометрии в приложении Tabit. Модуль интегрируется в существующую систему тестирования сотрудников, дополняя цветовой тест Люшера. Особое внимание уделяется последовательной оценке: Люшер → Социометрия → Люшер, что позволяет анализировать влияние эмоционального состояния на социальные выборы и обратное влияние социальных взаимодействий на эмоциональное состояние.
