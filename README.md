...
### 16. `make fill-company-tags`
Заполняет базу данных 1 компанией и 5 тегами к этой компании.

### 17. `make fill-user-tag-lings`
Заполняет базу данных 1 компанией, сотрудником этой компании, 5 тегами для этой компании и привязывает все 5 тегов к сотруднику.
