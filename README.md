...
- Контейнеры будут запущены в фоновом режиме (-d).
- Автоматически выполнится сборка образов, если произошли изменения.
...
Если необходимо выполнить миграции базы данных, используйте команду:
