...
### 12. `fill-companies`
Заполнит таблицу компаний в бд 10 фейковыми-сгенерированными компаниями.

### 13. `make fill-company-users`
Заполнит таблицу сотрудников компаний в бд 10 фейковыми-сгенерированными сотрудниками. Для этих пользователей в процессе выполнения скрипта создается компания, к которой привязываются создаваемые сотрудники.

### 14. `make fill-tabit_admin_users`
Заполнит таблицу сотрудников платформы Tabit в бд 10 фейковыми-сгенерированными сотрудниками.
