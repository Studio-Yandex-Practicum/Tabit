...
class TestCreateLicense:
    @pytest.mark.asyncio
    async def test_create_license(self, client: AsyncClient, superuser_token: str):
        ...
        response = await client.post(
            URL.LICENSES_ENDPOINT, json=license_data, headers=superuser_token
        )
    ...
    async def test_create_license_with_duplicate_name(
        self, client: AsyncClient, license_for_test, superuser_token: str
    ):
        ...
        response = await client.post(
            URL.LICENSES_ENDPOINT, json=duplicate_data, headers=superuser_token
        )
    ...
    @pytest.mark.asyncio
    async def test_create_license_missing_name(self, client: AsyncClient, superuser_token: str):
        ...
        response = await client.post(URL.LICENSES_ENDPOINT, json=data, headers=superuser_token)
    ...
    @pytest.mark.asyncio
    async def test_create_license_with_empty_name(self, client: AsyncClient, superuser_token: str):
    ...
    @pytest.mark.asyncio
    async def test_create_license_with_long_name(self, client: AsyncClient, superuser_token: str):
...
class TestGetLicense:
    ...
    async def test_get_licenses_default_pagination(
        ...
        response = await client.get(URL.LICENSES_ENDPOINT, headers=superuser_token)
    ...
    async def test_get_licenses_custom_pagination(
        ...
        response = await client.get(
            '/api/v1/admin/licenses/?page=2&page_size=5', headers=superuser_token
        )
    ...
    async def test_get_licenses_invalid_pagination(
        ...
        """
        response = await client.get(
            '/api/v1/admin/licenses/?page=1&page_size=0', headers=superuser_token
        )
        assert response.status_code == status.HTTP_422_UNPROCESSABLE_ENTITY

        response = await client.get(
            '/api/v1/admin/licenses/?page=1&page_size=101', headers=superuser_token
        )
        assert response.status_code == status.HTTP_422_UNPROCESSABLE_ENTITY
    ...
    async def test_get_licenses_sorting(
        ...
        response = await client.get(
            '/api/v1/admin/licenses/?ordering=name', headers=superuser_token
        )
        assert response.status_code == status.HTTP_200_OK
        result = response.json()
        ...
        response = await client.get(
            '/api/v1/admin/licenses/?ordering=created_at', headers=superuser_token
        )
        assert response.status_code == status.HTTP_200_OK
        result = response.json()
        ...
        response = await client.get(
            '/api/v1/admin/licenses/?ordering=updated_at', headers=superuser_token
        )
        assert response.status_code == status.HTTP_200_OK
        result = response.json()
    ...
    async def test_get_license_by_id(
        ...
        response = await client.get(
            f'/api/v1/admin/licenses/{new_license.id}', headers=superuser_token
        )
    ...
    @pytest.mark.asyncio
    async def test_get_license_not_found(self, client: AsyncClient, superuser_token: str):
        ...
        """
        response = await client.get('/api/v1/admin/licenses/99999', headers=superuser_token)
...
class TestPatchLicense:
    ...
    async def test_patch_license_success(
        ...
        response = await client.patch(
            f'/api/v1/admin/licenses/{new_license.id}', json=patch_data, headers=superuser_token
        )
    ...
    async def test_update_license_with_duplicate_name(
        ...
        response = await client.patch(
            f'/api/v1/admin/licenses/{license_2.id}', json=patch_data, headers=superuser_token
        )
    ...
    @pytest.mark.asyncio
    async def test_patch_license_not_found(self, client: AsyncClient, superuser_token: str):
        ...
        response = await client.patch(
            '/api/v1/admin/licenses/99999', json=patch_data, headers=superuser_token
        )
        assert response.status_code == status.HTTP_404_NOT_FOUND
...
class TestDeleteLicense:
    ...
    @pytest.mark.asyncio
    async def test_delete_license_not_found(self, client: AsyncClient, superuser_token: str):
        ...
        response = await client.delete(
            f'/api/v1/admin/licenses/{non_existent_id}', headers=superuser_token
        )
